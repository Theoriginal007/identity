    ...
    <section className="bg-[#F8F9FA] text-[#3C3E50] py-16">
      <div className="max-w-6xl mx-auto text-center">
        <div className="flex flex-wrap justify-between gap-8">
          ...
          {/* Who We Are Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 flex-1 min-w-[300px] border-l-4 border-[#002D72]">
          ...
          {/* Our Mission Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 flex-1 min-w-[300px] border-l-4 border-[#FF5722]">
          ...
          {/* Why Choose Us Card */}
          <div className="bg-white shadow-lg rounded-lg p-6 flex-1 min-w-[300px] border-l-4 border-[#4CAF50]">
...
{/* Call to Action */}
<div className="max-w-6xl mx-auto text-center py-16 px-6 bg-white">
  <h3 className="text-4xl font-semibold mb-6 text-[#333]">Let’s Build Your Brand Together</h3>
  <p className="text-lg leading-relaxed max-w-3xl mx-auto mb-10 text-[#555]">
  ...
  <Link
    to="/contact"
    className="mt-8 px-8 py-3 bg-[#002D72] text-white font-bold border-2 border-[#002D72] rounded-lg transition-all duration-300 ease-in-out hover:bg-transparent hover:text-[#002D72] hover:border-[#002D72] transform hover:scale-105"
  >
    Get Started
  </Link>
</div>
